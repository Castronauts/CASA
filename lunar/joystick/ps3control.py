...
while(1):
	...
	# print(str(convert_range(cmdjoystick.get_axis(3))))
	# print(str(convert_range(cmdjoystick.get_axis(2))))
	...
	ser.write(" ")
	ser.write(str(convert_range(-cmdjoystick.get_axis(3))))
	ser.write(" ")
	ser.write(str(convert_range(cmdjoystick.get_axis(2))))
	ser.write("\n")

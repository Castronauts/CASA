...
# Generated: Wed May  2 16:24:55 2018
##################################################
...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.variable_sample_rate_0 = variable_sample_rate_0 = 2.4E6
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'antenna_capture', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.band_pass_filter_0 = filter.fir_filter_ccf(1, firdes.band_pass(
        	1, variable_sample_rate_0, 1.024E6, 1.034E6, 50, firdes.WIN_KAISER, 6.76))
        ...
        # Connections
        ##################################################
        self.connect((self.RTL820T, 0), (self.band_pass_filter_0, 0))    
    ...
    def set_variable_sample_rate_0(self, variable_sample_rate_0):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.variable_sample_rate_0, 1.024E6, 1.034E6, 50, firdes.WIN_KAISER, 6.76))

...
#define BRAKESPEEDX 2//what fraction of the moving speed to brake at 
#define BRAKESPEEDY 2
...
WAIT_SERIAL:
  ...
  {
    analogWrite(pinCamxPWM, lastxspeed / BRAKESPEEDX);
  ...
  {
    analogWrite(pinCamyPWM, lastyspeed / BRAKESPEEDY);
